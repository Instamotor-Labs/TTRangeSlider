...
- (void)initialiseControl {
    ...
    [self setHandleShadowOffset: CGSizeMake(0, 0.5)];
    [self setHandleShadowOpacity: 0.4];
    [self setHandleShadowRadius: 1.0];
    [self setHandleBorderColor: self.tintColor];
}
...
- (void)setHandleBorderColor:(UIColor *)borderColor {
    _handleBorderColor = borderColor;
    self.leftHandle.borderColor = borderColor.CGColor;
    self.rightHandle.borderColor = borderColor.CGColor;
}

- (void)setHandleBorderWidth:(CGFloat)borderWidth {
    _handleBorderWidth = borderWidth;
    self.leftHandle.borderWidth = borderWidth;
    self.rightHandle.borderWidth = borderWidth;
}

- (void)setHandleShadowOffset:(CGSize)shadowOffset {
    _handleShadowOffset = shadowOffset;
    self.leftHandle.shadowOffset = shadowOffset;
    self.rightHandle.shadowOffset = shadowOffset;
}

- (void)setHandleShadowRadius:(CGFloat)shadowRadius {
    _handleShadowRadius = shadowRadius;
    self.leftHandle.shadowRadius = shadowRadius;
    self.rightHandle.shadowRadius = shadowRadius;
}

- (void)setHandleShadowOpacity:(CGFloat)shadowOpacity {
    _handleShadowOpacity = shadowOpacity;
    self.leftHandle.shadowOpacity = shadowOpacity;
    self.rightHandle.shadowOpacity = shadowOpacity;
}
